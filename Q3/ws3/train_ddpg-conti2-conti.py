...
class DDPGAgent:
    ...
    def act(self, obs, deterministic=False):
        ...
        if not deterministic:
            noise = torch.distributions.Normal(0, 0.05).rsample().to(self.device)
    ...
    def save(self):
        ...
        }, "ckpt_q3_ddpg-conti2-conti.pt")
    
    def load(self, ckpt_name="ckpt_q3_ddpg-conti2.pt"):
...
def train():
    ...
    agent.load("ckpt_q3_ddpg-conti2.pt")
    ...
    for episode in tqdm(range(num_episodes)):
        ...
        if (episode+1)%10 == 0:
            ...
            plt.savefig('training_progress_ddpg-conti2-conti.png')
            plt.close()
