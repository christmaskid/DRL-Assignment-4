...
class SACAgent:
    ...
    def save(self):
        ...
        }, "ckpt_q3_sac_fixed_alpha02_lr1e-4.pt")
    
    def load(self, ckpt_name="ckpt_q3_sac_fixed_alpha02_lr1e-4.pt"):
...
def train(load_ckpt=None):
    ...
    for episode in tqdm(range(num_episodes)):
        ...
        if (episode+1)%10 == 0:
            ...
            plt.savefig('training_progress_sac_fixed_alpha02_lr1e-4.png')
            plt.close()
