...
class SACAgent:
    ...
    def save(self):
        ...
        }, "ckpt_q3_sac_conti-fixed.pt")
    
    def load(self, ckpt_name="ckpt_q3_sac_conti-fixed.pt"):
...
def train(load_ckpt=None):
    ...
    for episode in tqdm(range(num_episodes)):
        ...
        if (episode+1)%10 == 0:
            ...
            plt.savefig('training_progress_sac_conti-fixed.png')
            plt.close()
